...
-- №1
/*
CREATE TABLE `MosnterIncEmployees`(
	`EmployeeID` INTEGER UNSIGNED AUTO_INCREMENT,
	`MosnterName` VARCHAR(75) NOT NULL,
	`Type` VARCHAR(50) NOT NULL,
	`Departament` VARCHAR(100) NOT NULL DEFAULT'Нулевой отдел',
	`ScareLevel` TINYINT NOT NULL,
	PRIMARY KEY(`EmployeeID`)
);

-- № 1.1

INSERT `MosnterIncEmployees` (`MosnterName`, `Type`, `Departament`, `ScareLevel` )
VALUES 
...
CREATE TABLE `Employee`(
	`EmployeeID` INTEGER UNSIGNED AUTO_INCREMENT PRIMARY KEY,
	`FirstName` VARCHAR(50) NOT NULL,
	`LastName` VARCHAR(50) NOT NULL,
	`DateOfBirth` DATE NOT NULL,
	`HireBirth` DATE NOT NULL,
	`Position` VARCHAR(100) NOT NULL,
	`Salary`  FLOAT NOT NULL
);
*/

INSERT INTO `Employee` (`FirstName`, `LastName`, `DateOfBirth`, `HireBirth`, `Position`, `Salary` )
VALUES 
